class Theme:
    ...
    common = {
        ...
        'wire_edit':        (0, 0, 0),
        'vertex':           (0, 0, 0),
        'face_retopology':  (0.5, 0.5, 0.5, 0.5),
    }
    blue = {
    ...
    green = {
        ...
        'face_select':      (0, 0.9, 0.45, 0.5),
        'face_mode_select': (0, 0.9, 0.45, 0.5),
    }
    orange = {
    ...
    pink = {
        'vertex_select':    (1, 0.5, 1),
        'edge_select':      (0.85, 0.45, 0.85),
        'edge_mode_select': (0.85, 0.45, 0.85),
    ...
    def set_theme(context, theme):
        # Don't change the theme when Retopoflow is not running
