...
class Visualization_Settings:
    ...
    def update_settings(self):
        ...
        self._target_settings = {
            'poly color':                  (*color_frozen, 0.20),
            'poly color selected':         (*color_select, 0.20),
            'poly offset':                 0.000010,
            'poly dotoffset':              1.0,
            'poly mirror color':           (*color_frozen, 0.10),
            'poly mirror color selected':  (*color_select, 0.10),
            'poly mirror offset':          0.000010,
            'poly mirror dotoffset':       1.0,

            'line color':                  (*color_frozen, 1.00),
            'line color selected':         (*color_select, 1.00),
            'line width':                  2.0,
            'line offset':                 0.000012,
            'line dotoffset':              1.0,
            'line mirror stipple':         False,
            'line mirror color':           (*color_frozen, 0.25),
            'line mirror color selected':  (*color_select, 0.25),
            'line mirror width':           1.5,
            'line mirror offset':          0.000012,
            'line mirror dotoffset':       1.0,
            'line mirror stipple':         False,

            'point color':                 (*color_frozen, 1.00),
            'point color selected':        (*color_select, 1.00),
            'point color highlight':       (1.0, 1.0, 0.1, 1.0),
            'point size':                  7.5,
            'point size highlight':        10.0,
            'point offset':                0.000015,
            'point dotoffset':             1.0,
            'point mirror color':          (*color_frozen, 0.25),
            'point mirror color selected': (*color_select, 0.25),
