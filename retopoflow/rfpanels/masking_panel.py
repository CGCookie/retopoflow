...
def draw_masking_options(layout, context):
...
class RFMenu_PT_Masking(bpy.types.Panel):
    ...
    def draw(self, context):
        draw_masking_options(self.layout, context)
