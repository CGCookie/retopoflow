...
class Patches_Orientations:
    ...
    @staticmethod
    def create_set_orientation_operator(idname : str, label : str, value : int):
        print(f'GENERATING PATCHES ORIENTATIONS OP {idname}')
        ...
        _op = type(opname, (RFTool_OT_Patches_SetInsertMode, RFRegisterClass, Operator), {})

    # TODO: DO NOT CALL THESE HERE!  SHOULD ONLY GET CALLED ONCE
    #       COULD POTENTIALLY CREATE MULTIPLE OPERATORS WITH SAME NAME
    create_set_orientation_operator('Raycast', 'Raycast', 1)
    create_set_orientation_operator('Screen',  'Screen',  2)
    create_set_orientation_operator('Cut',     'Cut',     3)
...
class RFOperator_Patches_Insert_Template(RFOperator):
    bl_idname : str = 'retopoflow.patches_insert_template'
    bl_label : str = 'Patches Template'
    bl_description : str = 'Insert templated geometry'
...
class RFAssetShelf_Patches(RFAssetShelf):
    ...
    def poll(cls, context : Context) -> bool:
        ...
        # return not RFOperator_Patches_Insert_Template.is_active()
        return True
