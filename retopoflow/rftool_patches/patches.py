...
from bpy.types import Context, Operator, UILayout, WorkSpaceTool, Event, Operator, Mesh
...
class RFOperator_Patches_Insert(RFOperator):
    ...
    actions : Actions # pyright: ignore[reportUninitializedInstanceVariable]
    logic : Patches_Logic # pyright: ignore[reportUninitializedInstanceVariable]
    bm : BMesh # pyright: ignore[reportUninitializedInstanceVariable]
    em : Mesh # pyright: ignore[reportUninitializedInstanceVariable]
    M : Matrix # pyright: ignore[reportUninitializedInstanceVariable]
    Mi : Matrix # pyright: ignore[reportUninitializedInstanceVariable]
    Mit : Matrix # pyright: ignore[reportUninitializedInstanceVariable]
    edit_scale : float # pyright: ignore[reportUninitializedInstanceVariable]
    snappable : list[BMVert] # pyright: ignore[reportUninitializedInstanceVariable]
