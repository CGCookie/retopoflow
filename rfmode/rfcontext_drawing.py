...
class RFContext_Drawing:
    ...
    def _init_drawing(self):
        ...
        container = dd_general.add(UI_Container(vertical=False))
        container.add(UI_Label('Snap Verts:'))
        container = container.add(UI_Container(margin=0, vertical=False))
        container.add(UI_Button('All', self.snap_all_verts, tooltip='Snap all target vertices to nearest source point', align=0, margin=0))
        container.add(UI_Button('Selected', self.snap_selected_verts, tooltip='Snap selected target vertices to nearest source point', align=0, margin=0))
